...
CONFIG = "configs/baseline_beam1a_pending_eval35_e60.json"
PENDING = "configs/baseline_beam1a_pending_eval35_e60.pending_tasks.json"
...
pod = Pod(
    ...
    name="retinal-baseline-beam1a-eval35-e60-a10g",
    gpu="A10G",
    cpu=4,
    memory="32Gi",
    image=image,
