...
from models.dyunet.dyconv import DynamicConv
...
class DoubleConv(nn.Module): 
    def __init__(self, in_channels, out_channels, mid_channels=None):
        ...
        self.double_conv = nn.Sequential(
            DynamicConv(in_channels, mid_channels, kernel_size=3, padding='same'), 
            nn.BatchNorm2d(mid_channels), 
            nn.ReLU(inplace=True), 
            DynamicConv(mid_channels, out_channels, kernel_size=3, padding='same'), 
