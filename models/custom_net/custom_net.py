...
class SegModel(nn.Module):
    def __init__(self,in_channel,out_channel):
        ...
        self.up_encode_1 =  nn.ConvTranspose2d(256,128,kernel_size=4,stride=2,padding = 1,bias=False)
