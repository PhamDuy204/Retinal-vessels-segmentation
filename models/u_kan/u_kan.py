...
class SegModel(nn.Module):
    def __init__(self, num_classes, input_channels=1, deep_supervision=False, img_size=512, patch_size=64, in_chans=1, embed_dims=[256, 320, 512], no_kan=False,
    drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm, depths=[1, 1, 1], **kwargs):
        super().__init__()

        kan_input_dim = embed_dims[0]

        self.encoder1 = ConvLayer(1, kan_input_dim//8)  
