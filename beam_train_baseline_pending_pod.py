...
CONFIG = "configs/baseline_beam1_pending_eval35_e60.json"
PENDING = "configs/baseline_beam1_pending_eval35_e60.pending_tasks.json"
...
pod = Pod(
    ...
    name="retinal-baseline-beam1-eval35-e60-a10g2",
    gpu="A10G",
    gpu_count=2,
    cpu=4,
    memory="32Gi",
