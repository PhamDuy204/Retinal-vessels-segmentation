...
cmd = "\nset +e\ncd /mnt/code\nexport PYTHONFAULTHANDLER=1\nmkdir -p /outputs/beam-disabled-volume-smoke\nnvidia-smi --query-gpu=name,memory.total --format=csv,noheader\necho TRAIN_DISABLED_VOLUME_BEGIN\npython -u train.py \\\n  --model edae_net \\\n  --seed 456 \\\n  --experiment-id beam_disabled_volume_smoke_eval1 \\\n  --datasets DRIVE_patches \\\n  --data-root data \\\n  --output-root /outputs/beam-disabled-volume-smoke \\\n  --wandb-mode disabled \\\n  --batch_size 4 \\\n  --epochs 1 \\\n  --loss bce_loss \\\n  --learning_rate 0.001 \\\n  --patches 10 \\\n  --patch_size 64 \\\n  --train_type patch \\\n  --type_split window \\\n  --num-workers 0 \\\n  --eval-batch-size 64 \\\n  --eval-every 1 \\\n  --eval-start-epoch 1 \\\n  --tf32 \\\n  --resume\nstatus=$?\necho TRAIN_DISABLED_VOLUME_STATUS=$status\nfind /outputs/beam-disabled-volume-smoke -maxdepth 5 -type f | sed -n '1,80p'\nsleep 5\nexit $status\n"

pod = Pod(
    app="retinal-beam-disabled-volume-smoke",
    name="retinal-beam-disabled-volume-smoke-a10g",
    gpu="A10G",
    cpu=4,
    memory="32Gi",
    image=image,
